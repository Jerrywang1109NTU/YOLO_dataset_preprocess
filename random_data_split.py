...
parser.add_argument('--output_image_dir', type=str, default="dataset_0_bk/YOLO_data_6_24_1/images", help='图像输出路径')
parser.add_argument('--output_label_dir', type=str, default="dataset_0_bk/YOLO_data_6_24_1/labels", help='标签输出路径')
